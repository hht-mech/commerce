...
class Listing(models.Model):
    ...
    category = models.CharField(max_length=1, choices=CATEGORY_CHOICES, default=GENERAL)
    min_bid = models.DecimalField(
        max_digits=7, decimal_places=2, default=0,
        validators=[MinValueValidator(1, message="Starting Bid should be greater than 0$")]
        )
